...
func (c *fileUploadServiceClient) UploadFile(ctx context.Context, in *FileRequest, opts ...grpc.CallOption) (*FileResponse, error) {
...
func (UnimplementedFileUploadServiceServer) UploadFile(context.Context, *FileRequest) (*FileResponse, error) {
...
func _FileUploadService_UploadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileUploadServiceServer).UploadFile(ctx, req.(*FileRequest))
	}
