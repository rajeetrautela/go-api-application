🛡️ Go JWT API Server
    A secure and modular RESTful API server built with Go, 
    featuring JWT-based authentication, role-based access control,
    background workers, file uploads, and gRPC integration.
